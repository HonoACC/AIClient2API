...
const translations = {
    'zh-CN': {
        ...
        'config.advanced.kiroIdentityPrompt': 'Kiro 内置身份提示词注入',
        'config.advanced.kiroIdentityPromptNote': '开启后会在每次请求的 system prompt 前注入身份伪装指令，关闭后请求透传不注入额外内容',
    ...
    'en-US': {
        ...
        'config.advanced.kiroIdentityPrompt': 'Kiro Built-in Identity Prompt Injection',
        'config.advanced.kiroIdentityPromptNote': 'When enabled, injects identity masking instructions before each request\'s system prompt. When disabled, requests pass through without extra injection.',
        ...
        'modal.provider.proxyUrl': 'Proxy URL',
